<template>
	<!-- el form item -->
	<el-form-item :label="label" :prop="prop" :rules="{ valid:valid, label:label, lang:$t, type:validType, validator:validator, password:password, unique:validUnique, trigger:validTrigger }" v-bind="formItemProps">
		<!-- span -->
