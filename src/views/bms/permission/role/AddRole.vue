<template>
	<el-dialog v-model="visible" title="新增角色" :close-on-click-modal="false" draggable width="480px">
		<el-form ref="formRef" :model="role" :rules="rules" label-width="120px" @keyup.enter="addRole">
			...
			<el-form-item>
				...
				<el-button type="success" @click="addRole"><sw-icon icon="save"></sw-icon>保存</el-button>
...
// import apis
import { $addRole } from '@/api/bms/permission/role'
...
const rules = ref({
	...
	roleCode: [{ label:'角色编码', valid:'r|l-le200', unique:{ code:'bms.permission.role.role_code.add', args:[] }, lang:t, validator:validator, trigger:'blur' }],
