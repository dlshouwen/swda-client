<template>
	<el-dialog v-model="visible" title="新增邮件平台" :close-on-click-modal="false" draggable width="480px">
		<el-form ref="formRef" :model="emailPlatform" :rules="rules" label-width="120px" @keyup.enter="addEmailPlatform">
			...
			<el-divider />
			<template v-if="emailPlatform.emailPlatformType==='0'">
			...
			<template v-if="emailPlatform.emailPlatformType==='1'">
			...
			<el-form-item>
				...
				<el-button type="success" @click="addEmailPlatform"><sw-icon icon="save"></sw-icon>保存</el-button>
...
// import apis
import { $addEmailPlatform } from '@/api/bms/platform/emailPlatform'
...
const addEmailPlatform = ()=>{
	...
	formRef.value.validate((valid:boolean)=>{
		...
		// add email platform
		$addEmailPlatform(emailPlatform).then(()=>{
			// message
