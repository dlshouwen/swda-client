<template>
	<el-dialog v-model="visible" title="新增短信平台" :close-on-click-modal="false" draggable width="480px">
		<el-form ref="formRef" :model="smsPlatform" :rules="rules" label-width="120px" @keyup.enter="addSmsPlatform">
			...
			<el-form-item>
				...
				<el-button type="success" @click="addSmsPlatform"><sw-icon icon="save"></sw-icon>保存</el-button>
...
// import apis
import { $addSmsPlatform } from '@/api/bms/platform/smsPlatform'
...
const addSmsPlatform = ()=>{
	...
	formRef.value.validate((valid:boolean)=>{
		...
		// add sms platform
		$addSmsPlatform(smsPlatform).then(()=>{
			// message
