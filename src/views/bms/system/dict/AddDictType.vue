<template>
	<el-dialog v-model="visible" title="新增字典类型" :close-on-click-modal="false" draggable width="480px">
		<el-form ref="formRef" :model="dictType" :rules="rules" label-width="120px" @keyup.enter="addDictType">
			...
			<el-form-item>
				...
				<el-button type="success" @click="addDictType"><sw-icon icon="save"></sw-icon>保存</el-button>
...
// import apis
import { $addDictType } from '@/api/bms/system/dictType'
...
const rules = ref({
	...
	dictType: [{ label:'字典类型', valid:'r|l-le200', unique:{ code:'bms.system.dict_type.dict_type.add', args:[] }, lang:t, validator:validator, trigger:'blur' }],
