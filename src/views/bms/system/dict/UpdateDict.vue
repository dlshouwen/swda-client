<template>
	<el-dialog v-model="visible" title="编辑字典" :close-on-click-modal="false" draggable width="480px">
		<el-form ref="formRef" :model="dict" :rules="rules" label-width="120px" @keyup.enter="updateDict">
			...
			<el-form-item>
				...
				<el-button type="success" @click="updateDict"><sw-icon icon="save"></sw-icon>保存</el-button>
...
// import apis
import { $getDictData, $updateDict } from '@/api/bms/system/dict'
...
const getDictData = async (dictId)=>{
	...
	// set dict data
	Object.assign(dict, handler.data)
}
