<template>
	<el-dialog v-model="visible" title="新增区域" :close-on-click-modal="false" draggable width="480px">
		<el-form ref="formRef" :model="region" :rules="rules" label-width="120px" @keyup.enter="addRegion">
			...
			<el-form-item prop="regionId" label="区域编号">
				<el-input v-model="region.regionId" :min="0" placeholder="请输入区域编号"></el-input>
			</el-form-item>
			...
			<el-form-item>
				...
				<el-button type="success" @click="addRegion"><sw-icon icon="save"></sw-icon>保存</el-button>
...
// import apis
import { $getRegionList, $addRegion } from '@/api/bms/system/region'
...
// const rules
const rules = ref({
	regionId: [{ label:'区域编号', valid:'r|integer|l-le11', unique:{ code:'bms.system.region.region_id.add', args:[] }, lang:t, validator:validator, trigger:'blur' }],
