<template>
	<el-dialog v-model="visible" title="编辑系统" :close-on-click-modal="false" draggable width="480px">
		<el-form ref="formRef" :model="system" :rules="rules" label-width="120px" @keyup.enter="updateSystem">
			...
			<el-form-item>
				...
				<el-button type="success" @click="updateSystem"><sw-icon icon="save"></sw-icon>保存</el-button>
...
// import apis
import { $getSystemData, $updateSystem } from '@/api/bms/system/system'
...
// const current system id
const currentSystemId = computed(()=>system.systemId)

// const rules
const rules = ref({
	systemCode: [{ label:'系统编码', valid:'r|l-le200', unique:{ code:'bms.system.system.system_code.update', args:[currentSystemId] }, lang:t, validator:validator, trigger:'blur' }],
...
const getSystemData = async (systemId:number)=>{
	...
	// set system data
	Object.assign(system, handler.data)
	// set rules
	rules.value.systemCode[0].unique.args[0] = system.systemId
}
