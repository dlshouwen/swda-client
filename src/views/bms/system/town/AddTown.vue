<template>
	<el-dialog v-model="visible" title="新增街道" :close-on-click-modal="false" draggable width="480px">
		<el-form ref="formRef" :model="town" :rules="rules" label-width="120px" @keyup.enter="addTown">
			...
			<el-form-item prop="townId" label="街道编号">
				<el-input v-model="town.townId" :min="0" placeholder="请输入街道编号"></el-input>
			</el-form-item>
			...
			<el-form-item>
				...
				<el-button type="success" @click="addTown"><sw-icon icon="save"></sw-icon>保存</el-button>
...
// import apis
import { $addTown } from '@/api/bms/system/town'
...
// const rules
const rules = ref({
	townId: [{ label:'街道编号', valid:'r|integer|l-le11', unique:{ code:'bms.system.town.town_id.add', args:[] }, lang:t, validator:validator, trigger:'blur' }],
